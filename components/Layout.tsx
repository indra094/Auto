        ...
        <div className="p-4 border-t border-slate-700 bg-slate-900 shrink-0">
          <div className="flex items-center gap-3">
             ...
             <div className="overflow-hidden">
               ...
               <div className="text-xs text-slate-500 truncate">{user?.email || "guest@auto.com"}</div>
             </div>
          </div>
        </div>
      </aside>
        ...
        <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-4 md:px-6 shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 text-sm text-slate-500">
               ...
               <span className="px-2 py-0.5 rounded-full bg-indigo-50 text-indigo-700 text-xs border border-indigo-100 font-medium">{stage}</span>
            </div>
          </div>
